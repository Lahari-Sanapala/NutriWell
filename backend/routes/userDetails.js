...
router.post("/upload-image", async (req, res) => {
  try {
    ...
    const pythonResponse = await axios.post("http://10.12.25.176:8501/analyze", {
      base64Image,
      userId
    });
    ...
    const pythonResponseCalorie = await axios.post("http://10.12.25.176:8501/analyzeCalorie", {
      summary
    });
